...
data_x, data_y = load_imgs(datapath='data_debug', classes=classes, target_size=target_size)
...
# load the model
model_shoes = load_model('model_shoes.h5')

# predict with the model
preds = model_shoes.predict(data_x, batch_size=1, verbose=1)
preds = np.argmax(preds, axis=1)
print('')
print('true labels: ' + str(data_y_int))
print('pred labels: ' + str(preds))
